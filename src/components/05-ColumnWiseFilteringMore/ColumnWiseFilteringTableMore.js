...
import { COLUMNS, GROUP_COLUMNS } from "./columnsForColumnFilterMore";
import MOCK_DATA from "../MOCK_DATA.json";

import "../table.css";
import GlobalFilter from "./GlobalFilter";
import ColumnFilterMore from "./ColumnFilterMore";

const ColumnWiseFilteringTableMore = () => {
...
export default ColumnWiseFilteringTableMore;
